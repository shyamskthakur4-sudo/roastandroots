...
export function Header({ cartCount, onOpenCart }) {
  const [compact,setCompact]=useState(false); const [menu,setMenu]=useState(false); const location=useLocation();
